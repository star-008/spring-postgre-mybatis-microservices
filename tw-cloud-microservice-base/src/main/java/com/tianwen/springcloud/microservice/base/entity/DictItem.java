...
public class DictItem extends BaseEntity{
    ...
    public DictItem(String dictid, String lang) {
        this.dictid = dictid;
        this.lang = lang;
    }

    public DictItem(String dictid, String lang, String dictname, String dictvalue) {
        this(dictid, lang);
    ...
    private boolean equals(DictItem dictItem) {
        return StringUtils.equals(dictvalue, dictItem.dictvalue) && StringUtils.equals(dicttypeid, dictItem.dicttypeid);
    }
}
