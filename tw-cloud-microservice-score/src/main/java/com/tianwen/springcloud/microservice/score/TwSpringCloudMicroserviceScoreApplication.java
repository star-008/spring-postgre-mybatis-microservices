package com.tianwen.springcloud.microservice.score;
...
public class TwSpringCloudMicroserviceScoreApplication {
    public static void main(String[] args) {
        System.out.println("TwSpringCloudMicroserviceScoreApplication before");

        BasicConfigurator.configure();
        SpringApplication.run(TwSpringCloudMicroserviceScoreApplication.class, args);

        System.out.println("TwSpringCloudMicroserviceScoreApplication after");
    }
}
